    ...
    if (!function_exists('Woocommerce_Add_ZarinPal_Gateway') && class_exists('WC_Payment_Gateway') && !class_exists('WC_ZPal')) {
        ...
        class WC_ZPal extends WC_Payment_Gateway
        {
            ...
            public function __construct()
            {
                ...
                $this->method_description = '<div style="position: relative">' . __('تنظیمات درگاه پرداخت زرین پال برای ووکامرس', 'woocommerce');
                $this->method_description .= '<img src="' . WP_PLUGIN_URL . '/' . plugin_basename(__DIR__) . '/assets/images/ZarinPal_Horizontal_WhiteBG1.png' . '" style="width:90px;position: absolute; padding-right: 10px"> </div>';
